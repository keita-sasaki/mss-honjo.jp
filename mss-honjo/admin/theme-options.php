...
/**
 * muum オプションTools デフォルト画像設定フィルター
 */
function muum_theme_options_tools_get_default_images_settings( $default_images_settings ) {
	// デフォルト画像設定
	return array(
/*
		array(
...
/**
 * muum オプションTools サンプルカテゴリー
 */
function muum_theme_options_tools_set_sample_categories( $dp_options ) {
...
/**
 * muum オプションTools サンプル記事 ---------------------------------------------------------------------------
 */
function muum_theme_options_tools_set_sample_posts( $dp_options ) {

	// ブログのアイキャッチ画像
	$media_id = (int) theme_options_tools_get_media_id( array(
		'media_filename' => 'image_1005x600.gif',
		'source_filepath' => get_template_directory() . '/admin/img/default/image_1005x600.gif'
	), true );
...
/**
 * muum オプションTools サンプルメニュー ------------------------------------------------------------------
 */
function muum_theme_options_tools_set_sample_menus( $dp_options ) {
	...
	$menu_locations['footer-menu-left'] = (int) $menu_id;
	$menu_locations['footer-menu-right'] = (int) $menu_id;
...
/**
 * muum オプションTools サンプルウィジェット（ブログページ左） -----------------------------------------------------------------
 */
function muum_theme_options_tools_set_sample_widgets( $dp_options ) {
 ...
 * muum テーマ初期化フィルター ----------------------------------------------------------------------------
 */
add_filter( 'tcd_theme_options_tools-get_default_images_settings', 'muum_theme_options_tools_get_default_images_settings', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'muum_theme_options_tools_set_sample_categories', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'muum_theme_options_tools_set_sample_posts', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'muum_theme_options_tools_set_sample_menus', 10, 1 );
add_filter( 'tcd_theme_options_tools-initialize', 'muum_theme_options_tools_set_sample_widgets', 10, 1 );
