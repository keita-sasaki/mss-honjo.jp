...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_rebirth.xml';
    $db_cache_field = 'rebirth-contempo-notifier-cache';
    $db_cache_field_last_updated = 'rebirth-contempo-notifier-last-updated';
