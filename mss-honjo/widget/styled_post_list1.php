  ...
  <a class="clearfix animate_background" href="<?php the_permalink() ?>">
   ...
   <div class="title_area">
    <div class="title_area_inner">
     <p class="meta">
     <?php if($show_date) { ?><span class="date"><time class="entry-date updated" datetime="<?php the_modified_time('c'); ?>"><?php the_time('Y.m.j'); ?></time></span><?php }; ?>
     <?php
...
<div class="btn-viewmore"><a href="<?php echo home_url(); ?>/column">VIEW MORE</a></div>
<?php
